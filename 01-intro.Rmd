...
kable(aktif) %>%
  ...
  pack_rows("FKIP", 13, 30, label_row_css = "background-color: #666; color: #fff;") %>%
  ...
  pack_rows("FEB", 41, 49, label_row_css = "background-color: #666; color: #fff;") %>%
  pack_rows("FISIP", 50, 52, label_row_css = "background-color: #666; color: #fff;") %>%
